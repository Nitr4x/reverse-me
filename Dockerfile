...
RUN apt -y install libc-dev dpkg-dev g++ build-essential bsdmainutils unzip python man gdb git radare2 strace emacs gcc valgrind wget curl python-pip python3 libssl-dev libffi-dev qemu binfmt-support qemu-user-static htop
